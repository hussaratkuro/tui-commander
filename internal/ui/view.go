...
var helpBindings = []helpBinding{
	...
	{"F11 / Shift+Tab / Ctrl+PgUp", "Activate the previous tab"},
	{"F12 / Ctrl+PgDown", "Activate the next tab"},
	{"Click a tab", "Activate the clicked tab"},
	{"Tab", "Switch the active pane"},
	{"Ctrl+Left / Ctrl+Right", "Open directory in other pane"},
	...
	{"Alt+M", "Merge two in selection order"},
